...
**Full-stack financial data processing system** with async document ingestion, PostgreSQL, background jobs, and deterministic analytics (materialized summaries).
